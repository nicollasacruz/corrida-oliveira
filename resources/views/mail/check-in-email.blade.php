...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0"
    ...
    <tr>
        <td style="background-color: #005fe0; padding: 20px; text-align: center; border-top-left-radius: 8px; border-top-right-radius: 8px;">
            <h1 style="color: #ffffff; font-size: 24px; margin: 0;">🎉 Hora do seu Check-In 🎉</h1>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding: 20px; text-align: center;">
            ...
            <span style="color: #005fe0; font-size: 22px">Sua inscrição está confirmada com sucesso! 🎊</span>
            ...
            <p style="color: #555; font-size: 16px; line-height: 1.5;">
                ...
                horários:
                <br/>
                <bold>21 e 22 de Maio de 2026, das 21h às 22h30 na Junta de Freguesia de Oliveira</bold>
                <br/>
